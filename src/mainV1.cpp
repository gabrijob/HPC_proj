                               ...
                               bool writeGraph)
{
    ...
    if(writeGraph)
    {
        ...
        TF_CHECK_OK(w->WriteGraph(0, absl::make_unique<GraphDef>(graph)));
    }
    return Status::OK();
}
...
{
    tstring image = "data/grace_hopper.jpg";
    ...
    Status write_tensor_staus = WriteTensorToImageFile("data/output.jpg", input_height, input_width, input_mean, input_std, resized_tensors);
    return 0;
}
